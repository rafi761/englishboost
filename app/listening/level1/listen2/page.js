  ...
  return (
    <div className="flex flex-col gap-[32px] mt-28 max-w-7xl mx-auto px-8 xl:px-0">
        ...
        <div className="lg:mx-auto">
            <iframe className="w-full h-[300px] sm:h-[400px] lg:w-[768px] lg:h-[400px]" src="https://www.youtube.com/embed/dz9cZWGM1Zs" title="YouTube video" allowFullScreen></iframe>
        </div>
    </div>
  )
}
